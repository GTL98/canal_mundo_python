...
class Jogador:
    def __init__(self):
        ...
        self.imagem_direita = pygame.image.load('./assets/sprites/jogador/jogador_direita.png').convert_alpha()
        self.imagem_direita = pygame.transform.scale(self.imagem_direita, (LARGURA_JOGADOR, ALTURA_JOGADOR))
        self.imagem_esquerda = pygame.image.load('./assets/sprites/jogador/jogador_esquerda.png').convert_alpha()
